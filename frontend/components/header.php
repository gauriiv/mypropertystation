...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@500;600;700;800&family=Outfit:wght@300;400;500;600;700&family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
...
<div class="header-fixed-wrapper" id="header-fixed-wrapper">
    ...
    <div class="top-bar" id="top-bar">
        <div class="container top-bar-container">
            <div class="top-bar-item"><i class="fa-solid fa-location-dot"></i> Location - Faridabad, Haryana India</div>
            <div class="top-bar-item"><i class="fa-solid fa-envelope"></i> info@mypropertystation.com</div>
            <div class="top-bar-item"><i class="fa-solid fa-envelope"></i> support@mypropertystation.com</div>
            <div class="top-bar-item"><i class="fa-solid fa-phone"></i> +91-7827771777</div>
            <div class="top-bar-item"><i class="fa-solid fa-phone"></i> +91-9999566126</div>
        </div>
    </div>
    ...
    <header class="main-header" id="main-header">
        <div class="header-inner">
            ...
            <a href="index.php" class="brand-logo">
                ...
                <span class="brand-name">MYPROPERTY<span class="gold-text">STATION</span></span>
            </a>
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-dropdown">
                    <a href="projects.php" class="nav-link <?php echo ($currentPage == 'projects.php') ? 'active' : ''; ?>">PROJECTS <i class="fas fa-chevron-down" style="font-size: 0.7rem; margin-left: 0.2rem;"></i></a>
            ...
            <div class="nav-actions">
                <a href="tel:+919999566126" class="header-phone-btn"><i class="fa-solid fa-phone" style="color: #d4af37; margin-right: 0.5rem;"></i> +91 99995 66126</a>
...
<div class="mobile-nav" id="mobile-nav">
    ...
    <ul class="mobile-menu-list">
        ...
        <li class="mobile-dropdown-trigger">
            <a href="projects.php" class="mobile-dropdown-toggle">PROJECTS <i class="fas fa-chevron-down mobile-caret"></i></a>
        ...
        <li><a href="commercial_dealers.php">COMMERCIAL DEALERS</a></li>
    ...
    <div class="mobile-actions" style="margin-top: 2rem;">
        <a href="tel:+919999566126" class="header-phone-btn" style="margin-bottom: 1rem; justify-content: center;"><i class="fa-solid fa-phone"></i> +91 99995 66126</a>
        <button id="mobileEnquireBtn" class="btn-enquire" style="width: 100%;">ENQUIRE NOW</button>
    </div>
</div>

<!-- Quick Enquiry Header Modal -->
